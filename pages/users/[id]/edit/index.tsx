...
export default function Page() {
    ...
    return(
        <Layout>
            <h1 className="text-lg font-medium"><span className="text-muted-foreground">Edit user :</span> {data && data.email} - "{data && data.username}"</h1>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4 lg:gap-6 mt-6 mx-auto">
                    ...
                    <Button type="submit" className="w-1/2 mt-4 justify-self-center">Submit</Button>
                </form>
            </Form>
        </Layout>
    )
