...
const FAQ: FC<FAQProps> = () => {
  ...
  return(
  <div className="faq bg-black/[0.03] w-full border-t">
      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen} className="w-full space-y-2">
        <div className="flex items-center justify-between px-4">
          ...
          <CollapsibleTrigger asChild>
              <Image src="https://img.icons8.com/?size=100&id=101363&format=png&color=000000" alt="" width="32" height="32"/>
          </CollapsibleTrigger>
        </div>
        ...
        <CollapsibleContent className="flex justify-between items-start flex-wrap">
          {faqs.map((faq, index) => (
            <details key={index} className="rounded-md border px-4 py-2 w-[48%] mt-2 text-sm shadow-sm bg-white">
