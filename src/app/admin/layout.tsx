    ...
    return (
        <>
            ...
            <div className="flex mt-4 gap-6">
                <div className="grid gap-4 w-1/3 h-fit grid-cols-1">
                    <Card className="outline-1 outline-primary outline object-fit text-center">
                        <CardHeader>
                            <h1 className="font-medium">Admin Dashboard</h1>
                        </CardHeader>
                    </Card>
                    <nav className="grid gap-2 p-6 w-full grid-cols-1 justify-start">
                        <Separator />
                        <h2 className="text-lg">Courses</h2>
                        <Link href={`/admin/courses/new`}>
                            <Button variant="ghost" className={`!w-full text-start text-wrap hover:border-primary !py-2 px-6 text-muted-foreground hover:text-foreground`}>
