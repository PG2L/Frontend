                ...
                <>
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>{data.username}</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                    <div className="grid lg:flex gap-4 lg:gap-6 grid-cols-1 rounded-lg mt-6">
                        <div className="grid grid-cols-1 gap-4 lg:gap-6 h-fit w-full lg:w-1/3">
                            <Card className="hidden sm:block w-full">
                                <CardHeader className="flex justify-center items-center gap-4 rounded">
                                    <h1 className="text-lg font-medium text-center">Profil</h1>
                                </CardHeader>
                            </Card>
                            <Card>
                                    ...
                                    <Collapsible className="text-lg font-medium">
                                        <CollapsibleTrigger asChild>
                                            <div className="flex items-center justify-between">
                                                <h2 className=" font-medium">Show quests logs</h2>
